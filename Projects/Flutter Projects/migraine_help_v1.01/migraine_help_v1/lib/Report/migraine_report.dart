// ignore_for_file: non_constant_identifier_names, prefer_const_constructors_in_immutables, prefer_const_constructors, prefer_const_literals_to_create_immutables, constant_identifier_names, unnecessary_new, unnecessary_const
...
class MigraineReport extends StatefulWidget {
  final ImageProvider face_side_2;
  final ImageProvider head_top_2;
  final ImageProvider migraine_big_pain_1;
  MigraineReport({
    Key? key,
    this.face_side_2 = const AssetImage('assets/images/face_side.png'),
    this.head_top_2 = const AssetImage('assets/images/head_top.png'),
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //Text '- Pain in following areas:'
          Pinned.fromPins(
            Pin(size: 151.0, start: 9.5),
            Pin(size: 19.0, middle: 0.671),
            child: Text(
              '- Pain in following areas:',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 14,
                color: const Color(0xffffffff),
          ...
          //Side View Report
          Pinned.fromPins(
            Pin(size: 101.0, start: 0.5),
            Pin(size: 103.0, end: 104.0),
            child:
                // Adobe XD layer: 'Side View' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: widget.face_side_2,
                  fit: BoxFit.fill,
                ),
              ),
            ),
          ...
          //Top View Report
          Pinned.fromPins(
            Pin(size: 92.0, middle: 0.416),
            Pin(size: 103.0, end: 104.0),
            child:
                // Adobe XD layer: 'Top View' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: widget.head_top_2,
                  fit: BoxFit.fill,
                ),
              ),
            ),
...
const String _svg_ygjv45 =
    '<svg viewBox="0.0 497.7 360.0 1.0" ><path transform="translate(0.0, 497.73)" d="M 0 0 L 360 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-dasharray="3 3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_o7t9kz =
    '<svg viewBox="0.0 446.3 360.0 1.0" ><path transform="translate(0.0, 446.35)" d="M 0 0 L 360 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-dasharray="3 3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
