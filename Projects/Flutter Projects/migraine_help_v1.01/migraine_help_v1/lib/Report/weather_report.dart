// ignore_for_file: prefer_const_constructors_in_immutables, non_constant_identifier_names, prefer_const_constructors, prefer_const_literals_to_create_immutables, unnecessary_new, constant_identifier_names, unnecessary_const
...
class WeatherReport extends StatefulWidget {
  final ImageProvider cloudy_big_1;
  WeatherReport({
    Key? key,
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //Weather Report
          Pinned.fromPins(
            Pin(size: 140.0, start: 10.0),
            Pin(size: 106.0, middle: 0.8168),
            child: Text(
              '- Rainy\n- Wind: South, 10km/h\n- 20 °C\n- Humidity: 80%',
              style: TextStyle(
                fontFamily: 'Segoe UI',
...
const String _svg_sj5fgv =
    '<svg viewBox="0.5 502.7 360.0 1.0" ><path transform="translate(0.5, 502.73)" d="M 0 0 L 360 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-dasharray="3 3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_i0tv1f =
    '<svg viewBox="-0.5 451.3 360.0 1.0" ><path transform="translate(-0.5, 451.35)" d="M 0 0 L 360 0" fill="none" stroke="#ffffff" stroke-width="1" stroke-dasharray="3 3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
